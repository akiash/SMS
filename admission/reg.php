...
<div class="col-sm-2">
    ...
    <form id="prospectus_registration"  enctype="multipart/form-data" method="POST" Action="reg.php"> 
	   ...
	   <input type="hidden" name="reg_no" value="<?php echo(rand(100000,999999)); ?>">
			<div class="row">
				<div class="col-sm-6">
			...
			<div class="row">
				...
				<script>
					$('#class').change(function(){
						...
						var e = $(this).val();
						if(e>=11){
						var option = ["SCIENCE", "COMMERCE", "HUMANITIES"];		
						}
						else{
						var option = ["GENERAL"];
						}
