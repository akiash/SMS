...
<div class="row">
	<div class="col-md-4">Student's Watsapp No. : <input class="form-control" type="text" name="mobile2" id="stu_mobile"  class="required" style="width: 100%;" required /><label style="color:red;font-size:9px">* Enter Student's Mobile Number For Online Learning</label></div>
</div>
