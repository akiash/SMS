    ...
    <?php if (!empty($images) && $stats['total_images'] > 0): ?>
        ...
        <ul id="galleryList" class="clearfix">
            ...
            <?php foreach ($images as $image): ?>
                <li>
				<a href="#" title="<?php echo $image['file_title']; ?>">
					<img src="<?php echo $image['thumb_path']; ?>" alt="<?php echo $image['file_title']; ?>" data-jslghtbx="<?php echo $image['file_path']; ?>"  data-jslghtbx-group="mygroup1" />
				</a></li>
            <?php endforeach; ?>
