						    ...
						    <table align="center" class="table table-bordered table-striped responsive" style="font-size: 13px;width: 60%;">
							    <form name="form1" method="post" action="#" method="POST" enctype="multipart/form-data"/>
							        <input type="hidden" name="hdnCmd" value="ADD">
										...
										<tr>
											<td>Upload Files :</td>
											<td><input type="file" name="Hfile"  id="Hfile" /> <span style="color:red;">File Size Not Larger Than 1MB.</span>
												<div class="clear"></div>
												<div id="error2" style="font-size: 14; color: red; font-weight: 600"></div>
											</td>
										</tr>
										<tr>
											<th colspan="2"><center><input type="submit" value="Submit" id="check"   name="SAVE" onclick="return doFormSubmit()"/>
												<input type="reset" name="reset" value="Clear All" /></center>
											</th>
										</tr>
                                </form>
                            </table>                                      
