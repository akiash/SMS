...
<body>
	...
	<header class="header-user-dropdown">
		...
		<div class="header-limiter">
			<h1><a href="Uploads.php">D.G.S.G Public School<span>logo</span></a></h1>
			...
			<li>
			    <h4 style="color:white;font-size: 1.2em; margin-top:16px;"><?php  echo $_SESSION['A'];?></h4>
			</li>
            &nbsp;
            &nbsp;
            &nbsp;
			...
			<div class="header-user-menu">
				...
				<img id="cand_photo" src="<?php  echo $_SESSION['IMG']; ?>" alt="User Image" style="border: 2px solid #fff;"/>
