...
while($data=mysqli_fetch_array($rs)){
	...
	$_SESSION['A']=$data['fname']." ".$data['lname'];
			...
			<form action="" method="POST">
			    <div class="form-group">
                    <div class="controls">
                        ...
                        User Name</label>
                        <input type="email" id="email" required="" name="email" class="form-control input " autocomplete="new-email" maxlength="128" placeholder="User Name" value="" wtx-context="DD282BCE-FE69-4BA3-8E33-95BCEF9C2EF3">
                    </div>
                </div>
                <div class="form-group">
                    <div class="controls">
                ...
                <div class="form-group">
                    ...
                    <div class="forgot">
                        ...
                        <div class="right">
                        New to this rOOm? <a href="registration.php">Sign Up Free</a>
					    </div>
                    </div>
                    </div>
                </div>
